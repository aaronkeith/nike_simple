...
//   return n + (shoe.category == 'RUNNING SHOES');
// }, 0);
//
// var skateCategory = shoeInventory.reduce(function(n, shoe) {
//   return n + (shoe.category == 'SKATE SHOES');
// }, 0);
//
// var ballCategory = shoeInventory.reduce(function(n, shoe) {
...
function renderGalleryTitle(galleryTitle) {
  ...
  var countCategory = shoeInventory.reduce(function(n, shoe) {
    return n + (shoe.category === galleryTitle.category);
  }, 0);
  ...
  $galleryTitle.textContent = galleryTitle.category
